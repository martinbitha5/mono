      ...
      >
        ...
        <div className="relative flex-1 flex items-center justify-center px-5 py-10">
          <div className="w-full max-w-[380px]">
            <p className="font-mono text-[10px] tracking-[0.22em] text-blue-400 uppercase mb-3">
            ...
            <form onSubmit={handleSubmit} className="mt-8 space-y-4">
              ...
              <button
                ...
                className="w-full h-11 bg-blue-500 hover:bg-blue-400 active:bg-blue-600 disabled:opacity-40 disabled:cursor-not-allowed
