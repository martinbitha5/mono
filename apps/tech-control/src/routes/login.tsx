...
import { Eye, EyeOff, Wrench, ArrowRight, AlertCircle, CheckCircle2 } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none"
        style={{ background: 'radial-gradient(ellipse 70% 60% at 30% 50%, rgba(249,115,22,0.12) 0%, transparent 65%)' }} />
      ...
      <div className="relative w-full max-w-[420px] z-10">
        ...
        >
          ...
          <div className="flex items-center gap-3 mb-8">
            <div className="w-9 h-9 rounded-xl bg-orange-500/[0.15] border border-orange-500/20 flex items-center justify-center flex-shrink-0">
              <Wrench className="w-4 h-4 text-orange-400" />
            </div>
            <div>
              <p className="text-[14px] font-bold text-zinc-50 leading-tight">ATS Tech Control</p>
              <p className="text-[10px] text-zinc-500 leading-tight mt-0.5">Service Technique · RDC</p>
            </div>
          </div>

          <div className="mb-7">
            <h1 className="text-[24px] font-black text-zinc-50 tracking-tight">Connexion</h1>
            <p className="text-[13px] text-zinc-400 mt-1.5">Accédez à votre espace technique</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              ...
              className="w-full bg-orange-500 hover:bg-orange-400 active:bg-orange-600 disabled:opacity-40 disabled:cursor-not-allowed
                text-white text-[13px] font-semibold rounded-lg py-2.5 flex items-center justify-center gap-2
                transition-all shadow-lg shadow-orange-900/30 mt-2"
            >
              {loading ? (
