      ...
      <div className="relative w-full max-w-[400px] z-10">
        ...
        >
          ...
          <div className="mb-7">
            ...
            <p className="text-[13px] text-white/60 mt-2">Accédez à votre espace technique</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              ...
              className="w-full bg-orange-500 hover:bg-orange-400 active:bg-orange-600 disabled:opacity-40 disabled:cursor-not-allowed
                ...
                transition-all mt-2"
              style={{ boxShadow: loading || !email || !password ? 'none' : '0 4px 20px rgba(249,115,22,0.40)' }}
            >
              {loading ? (
