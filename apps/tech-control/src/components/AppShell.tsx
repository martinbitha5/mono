...
import {
  ...
  LogOut, Wrench, X, Truck, FileText, ClipboardCheck, Droplets,
  Bell, Zap, Info, Menu,
} from 'lucide-react';
...
const OPS_NAV: NavItem[] = [
  ...
  { to: '/gse',           label: 'Parc GSE',         icon: Truck           },
  { to: '/checklist',     label: 'Check List',       icon: ClipboardCheck  },
  { to: '/maintenance',   label: 'Maintenance',      icon: Wrench          },
  { to: '/carburant',     label: 'Carburant',        icon: Droplets        },
  { to: '/interventions', label: 'Interventions',    icon: AlertTriangle   },
  { to: '/schedule',      label: 'Planning',         icon: Calendar        },
];

const ADMIN_NAV: NavItem[] = [
  { to: '/agents',  label: 'Agents',   icon: Users,    roles: ['admin', 'supervisor'] },
...
const BOTTOM_NAV: NavItem[] = [
  ...
  { to: '/gse',           label: 'GSE',           icon: Truck           },
  { to: '/interventions', label: 'Urgences',      icon: AlertTriangle   },
  { to: '/maintenance',   label: 'Maintenance',   icon: Wrench          },
];
...
// ── Notification panel (shared desktop/mobile) ────────────────────────────────
function NotifPanel({
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-1.5">
                    ...
                    {!n.read && <div className="w-1.5 h-1.5 rounded-full bg-orange-500 flex-shrink-0" />}
                  </div>
      ...
      <div className="space-y-px">
        {visible.map(item => {
          ...
          return (
            ...
            >
              <Icon className={['w-[15px] h-[15px] flex-shrink-0', active ? 'text-orange-600' : 'text-zinc-400'].join(' ')} />
    ...
    >
      ...
      >
        ...
        <div className="flex items-center px-5 h-14 border-b border-[#E6E8F0] flex-shrink-0">
          <div className="min-w-0 flex-1">
            <p className="text-[13px] font-bold text-zinc-900 leading-tight truncate">ATS Tech Control</p>
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 h-14 border-b border-[#E6E8F0] flex-shrink-0">
          <div>
            <p className="text-[13px] font-bold text-zinc-900 leading-tight">ATS Tech Control</p>
            <p className="text-[10px] text-zinc-500 leading-tight mt-px">Service Technique</p>
          </div>
          ...
          <div className="space-y-0.5">
            {allNav.map(item => {
              ...
              return (
                ...
                >
                  <Icon className={['w-5 h-5 flex-shrink-0', active ? 'text-orange-600' : 'text-zinc-400'].join(' ')} />
        ...
        >
          ...
          <div className="flex lg:hidden items-center flex-1 min-w-0">
            <div className="min-w-0">
              <p className="text-[12px] font-bold text-zinc-900 leading-tight">ATS Tech Control</p>
              {profile?.site && (
            ...
            >
              ...
              {unreadCount > 0 && (
                <span className="absolute -top-0.5 -right-0.5 min-w-[16px] h-4 px-0.5
                  bg-orange-500 rounded-full text-[9px] font-bold text-white
            ...
            return (
              <Link
                ...
                className={[
                  ...
                  active ? 'text-orange-600' : 'text-zinc-400 hover:text-zinc-500',
                ].join(' ')}
              >
